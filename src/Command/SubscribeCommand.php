...
class SubscribeCommand extends Command
{
    ...
    {
        $this
            ->setName('event:subscribe')
            ->setDescription('Subscribe to receive events from server');
    }
    ...
    {
        try {
            $clientToken = $this->subscriptionService->subscribe($this->eventServerAddress);

            $output->writeln($clientToken->getServerHeader().': '.$clientToken->getServerToken());
